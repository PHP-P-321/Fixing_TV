...
mysqli_query($connect, "INSERT INTO `requests`
                        (`id_client`, `company_name`, `model_name`, `type_of_backlight`, `screen_diagonal`, `screen_refresh_rate`, `status`)
                        VALUES
                        ('$id_client', '$company_name', '$model_name', '$type_of_backlight', '$screen_diagonal', '$screen_refresh_rate', 1)
");
